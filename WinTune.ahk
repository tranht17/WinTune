...
global LangCode:=""
LangCode:=IniRead("config.ini", "Language", "Language", "")
If (LangCode=""){
	LangCode:="en"
}
...
global Lang:=JSON.parse(LangDataText,,False)
...
CreateGui() {
	...
	BtnSys_Language:=g.AddText('vBtnSys_Language x' (BtnSysX+=35) ' ym w30 h20 0x200 Center Border',Chr(0xE164)) ;0xE771
	BtnSys_Language.SetFont("s11",IconFont)
	BtnSys_Language.Opt("-Border")
