...
DisableCustomInking: {Name: "カスタム手描きを無効にする",Desc: "カスタム インクと入力辞書を無効にする"},
...
BtnSys_Search: {Desc: "최적화를 검색하십시오"},
...
DisableCustomInking: {Name: "맞춤 손 그리기 사용 중지",Desc: "맞춤 잉크 및 입력 사전 사용 안 함"},
