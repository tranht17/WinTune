...
AUOptions: {Name: "AU Seçenekleri",Desc: "Windows Güncellemelerini indirmeden önce bildir"},
AutoEndTasks: {Name: "Görevleri Otomatik Sonlandır",Desc: "Donmuş işlemleri kapat ve sistem çökmesini önle"},
BtnClearStartMenu: {Name: "Başlat Menüsünü Temizle"},
BtnHostsEdit: {Name: "Host Düzenle"},
...
BtnSys_Minimize: {Desc: "Küçült"},
BtnSys_ReloadTab: {Desc: "Bu sekmeyi yeniden yükle"},
BtnSys_SaveImage: {Desc: "Kendinden Yakalama ve Görüntü Olarak Kaydet"},
BtnSys_SaveOptimizeConfigAll: {Desc: "Tüm optimizasyon yapılandırmalarını dosyaya kaydet"},
BtnSys_SaveOptimizeConfigTab: {Desc: "Bu sekmenin optimizasyon yapılandırmasını dosyaya kaydet"},
BtnSys_Setting: {Desc: "Ayarlar"},
BtnSys_Theme: {Desc: "Tema"},
ClassicContextMenu: {Name: "Klasik Bağlam Menüsü"},
DiagnosticDataOff: {Name: "Tanı Verilerini Kapat"},
DisableAdsOnLockScreen: {Name: "Kilit Ekranındaki Reklamları Devre Dışı Bırak"},
DisableAeDebug: {Name: "AeDebug'u Devre Dışı Bırak",Desc: "Hata işleme hızını artırmak için hata ayıklayıcıyı devre dışı bırak"},
DisableAnimationEffectMaxMin: {Name: "Animasyon Efektini Devre Dışı Bırak",Desc: "Pencereyi maksimuma veya minimuma indirirken animasyon efektini kapat ve pencere yanıt hızını artır"},
DisableAppendCompletion: {Name: "Ekleme Tamamlamayı Devre Dışı Bırak",Desc: "Satır içi Otomatik Tamamlamayı (Ekleme tamamlamayı veya Otomatik doldurmayı) devre dışı bırak"},
DisableAutoDefragIde: {Name: "Otomatik Birleştirmeyi Devre Dışı Bırak",Desc: "IDE sırasında otomatik birleştirmeyi devre dışı bırak ve SSD'nin çalışma ömrünü uzat"},
DisableAutoInstallationApps: {Name: "Otomatik Uygulama Yüklemeyi Devre Dışı Bırak"},
DisableAutoplay: {Name: "Otomatik Oynatmayı Devre Dışı Bırak",Desc: "Sürücülerdeki “Otomatik Oynat” özelliğini devre dışı bırakarak virüs bulaşmasını önleyin"},
DisableAutoSuggest: {Name: "Otomatik Öneriyi Devre Dışı Bırak",Desc: "Otomatik Öneriyi (Otomatik tamamla açılır menüsü) devre dışı bırak"},
DisableAutoWindowsUpdates: {Name: "Otomatik Windows Güncellemelerini Devre Dışı Bırak",Desc: "Otomatik Güncellemeleri Devre Dışı Bırak"},
DisableBackgroundApps: {Name: "Arka Plan Uygulamalarını Devre Dışı Bırak"},
DisableBingSearchStartMenu: {Name: "Başlangıç Menüsünde Bing Aramayı Devre Dışı Bırak"},
DisableBootOptimize: {Name: "Başlangıç Optimizasyonunu Devre Dışı Bırak",Desc: "Başlangıçta sistem sürücüsünü birleştirmeyi devre dışı bırak ve SSD'nin çalışma ömrünü uzat"},
DisableCortana: {Name: "Cortana'yı Devre Dışı Bırak"},
DisableCortanaWindowsSearch: {Name: "Windows Aramasında Cortana'yı Devre Dışı Bırak",Desc: "Cortana'nın Windows Arama İşlevi olarak kullanılmasını durdurur"},
DisableCrashAutoReboot: {Name: "Çökme Sonrası Otomatik Yeniden Başlatmayı Devre Dışı Bırak",Desc: "Mavi ekran hatasıyla karşılaştığında otomatik olarak yeniden başlatmayı devre dışı bırak"},
DisableDiagTrack: {Name: "DiagTrack'i Devre Dışı Bırak"},
DisabledVBSCodeIntegrity: {Name: "VBS Kod Bütünlüğünü Devre Dışı Bırak",Desc: "Kod bütünlüğünün sanallaştırma tabanlı korumasını devre dışı bırak"},
DisableErrorReporting: {Name: "Hata Raporlamayı Devre Dışı Bırak",Desc: "Ekran hata raporlamayı devre dışı bırak ve sistem performansını artır"},
DisableFrequentFolders: {Name: "Sık Kullanılan Klasörleri Devre Dışı Bırak"},
DisableGameBar: {Name: "Oyun Çubuğu ve Oyun DVR'yi Devre Dışı Bırak",Desc: "Oyun DVR özelliği, arka planda oyun kaydetmenizi sağlar.`nOyun Çubuğunda bulunur ve Oyun DVR özelliği ile oyun kaydı ve ekran görüntüleri alma düğmeleri sunar.`nAncak, arka planda video kaydederek oyun performansınızı yavaşlatabilir."},
DisableGoogleUpdateTask: {Name: "Google Güncelleme Görevini Devre Dışı Bırak"},
DisableHibernate: {Name: "Hazırda Bekletmeyi Devre Dışı Bırak"},
DisableHybridSleep: {Name: "Hibrit Uykuyu Devre Dışı Bırak"},
DisableLockScreen: {Name: "Kilit Ekranını Devre Dışı Bırak"},
DisableLowDiskSpaceChecks: {Name: "Düşük Disk Alanı Kontrollerini Devre Dışı Bırak",Desc: "Disk G/Ç alt sistemini optimize ederek sistem performansını artır"},
Disablememorypagination: {Name: "Bellek Sayfalamayı Devre Dışı Bırak",Desc: "Bellek sayfalamayı devre dışı bırak ve disk G/Ç'yi azaltarak uygulama performansını artır.`n(Fiziksel bellek <1 GB ise seçenek göz ardı edilebilir)"},
DisableMenuShowDelay: {Name: "Menü Gösterme Gecikmesini Devre Dışı Bırak",Desc: "Sistem ekranı yanıt hızını optimize edin"},
DisableMicrosoftEdgeUpdateTask: {Name: "Microsoft Edge Güncelleme Görevini Devre Dışı Bırak"},
DisableMSDefender: {Name: "Microsoft Defender'ı Devre Dışı Bırak",Desc: "Microsoft Defender'ı 1 tıklama ile etkinleştir/devre dışı bırak.`nBilgisayarı otomatik olarak yeniden başlatacaktır."},
DisableOfferSuggestions: {Name: "Öneri Sunmayı Devre Dışı Bırak"},
DisablePersonalizedAdsStoreApps: {Name: "Kişiselleştirilmiş Reklamları Mağaza Uygulamalarında Devre Dışı Bırak"},
DisablePrefetchParameters: {Name: "Ön Yükleme Parametrelerini Devre Dışı Bırak",Desc: "Ön yükleme parametrelerini devre dışı bırak ve SSD'nin çalışma ömrünü uzat"},
DisablePrintSpooler: {Name: "Yazdırma Biriktiricisini Devre Dışı Bırak"},
DisableRecentFiles: {Name: "Son Dosyaları Devre Dışı Bırak"},
DisableRemoteRegAccess: {Name: "Uzak Kayıt Erişimini Devre Dışı Bırak",Desc: "Uzak bir bilgisayardan kayıt defteri değişikliklerini devre dışı bırak"},
DisableScheduledDefrag: {Name: "Zamanlanmış Birleştirmeyi Devre Dışı Bırak"},
DisableSettingsAppSuggestions: {Name: "Ayarlar Uygulamasında Önerileri Devre Dışı Bırak"},
DisableShortcutText: {Name: "Kısayol Metnini Devre Dışı Bırak"},
DisableSleep: {Name: "Uyku Modunu Devre Dışı Bırak"},
DisableSyncProviderNotifications: {Name: "Senkronizasyon Sağlayıcı Bildirimlerini Devre Dışı Bırak"},
DisableSystemRestore: {Name: "Sistem Geri Yüklemeyi Devre Dışı Bırak"},
DisableTailoredExperiences: {Name: "Özelleştirilmiş Deneyimleri Devre Dışı Bırak"},
DisableTipsAndSuggestions: {Name: "İpuçları ve Önerileri Devre Dışı Bırak"},
DisableTurnOffDisplay: {Name: "Ekranı Kapatmayı Devre Dışı Bırak"},
DisableVisualStudioTelemetry: {Name: "VisualStudio Telemetrisini Devre Dışı Bırak"},
DisableWCE: {Name: "WCE İyileştirmesini Devre Dışı Bırak",Desc: "Windows Müşteri Deneyimi İyileştirmesini devre dışı bırak`n`n- Proxy: Bu görev, Microsoft Müşteri Deneyimi İyileştirme Programına katıldıysanız autochk SQM verilerini toplar ve yükler.`n- Microsoft Uyumluluk Değerlendiricisi: Microsoft Müşteri Deneyimi İyileştirme Programına katıldıysanız program telemetri bilgilerini toplar."},
DisableWebSearch: {Name: "Web Aramasını Devre Dışı Bırak"},
DisableWebSearchStartMenu: {Name: "Başlat Menüsünde Web Aramasını Devre Dışı Bırak",Desc: "Başlat Menüsünde Web Aramasını devre dışı bırakır"},
DisableWindowsFeedback: {Name: "Windows Geri Bildirimini Devre Dışı Bırak"},
DisableWindowsSearch: {Name: "Windows Aramayı Devre Dışı Bırak"},
EnableDarkMode: {Name: "Koyu Modu Etkinleştir"},
HostEdit_BtnImportFromFile: {Name: "Dosyalardan İçe Aktar"},
HostEdit_BtnImportFromLink: {Name: "Bağlantıdan İçe Aktar"},
HostEdit_BtnInsertLink: {Desc: "Hosta İçe Aktar Bağlantısı Ekle"},
HostEdit_BtnReload: {Name: "Host dosyasını yeniden yükle"},
HostEdit_BtnResetDefault: {Name: "Varsayılanı Sıfırla"},
HostEdit_BtnSave: {Name: "Kaydet"},
HostEdit_BtnSaveAs: {Name: "Farklı Kaydet"},
IncreaseIconCache: {Name: "Simge Önbelleğini Artır",Desc: "Sistem simge önbelleğini artırın ve masaüstü ekran hızını artırın"},
IoPageLockLimit: {Name: "Io Sayfa Kilitleme Limiti",Desc: "Belleğin varsayılan ayarlarını optimize edin ve sistem performansını artırın"},
LinkResolveIgnoreLinkInfo: {Name: "Bağlantı Bilgisini Yoksay",Desc: "Dolaşım sırasında Kabuk kısayollarını takip etmeyin"},
Message_ClearStartMenu_Done: "Başlat Menüsü Temizlendi!",
Message_WaitDlg: "Lütfen bekleyin...",
MouseHoverTime: {Name: "Fare Üzerinde Bekleme Süresi",Desc: "Görev Çubuğu Pencere Önizlemelerinin ekran hızını artırın"},
NoInternetOpenWith: {Name: "İnternet Açılmasını Kapat",Desc: "İnternet Dosya İlişkilendirme hizmetini kapat"},
NoResolveSearch: {Name: "Aramayı Çözme",Desc: "Kabuk kısayollarını çözerken arama tabanlı yöntemi kullanmayın"},
NumLockonStartup: {Name: "Başlangıçta Num Lock"},
OpenFileExplorerThisPC: {Name: "Dosya Gezgini'ni Bu Bilgisayarda Aç"},
OptimizeNetworkTransfer: {Name: "Ağ Transferini Optimize Et",Desc: "Ağ ayarlarını optimize edin ve transfer performansını artırın"},
Optimizeprocessorperformance: {Name: "İşlemci Performansını Optimize Et",Desc: "İşlemci performansını optimize edin ve uygulamaların, oyunların vb. daha akıcı çalışmasını sağlayın."},
OptimizeRefreshPolicy: {Name: "Yenileme Politikasını Optimize Et",Desc: "Disk G/Ç alt sistemini optimize edin ve sistem performansını artırın"},
Optional: {Name: "İsteğe Bağlı"},
...
ShutdownAcceleration: {Name: "Kapatma Hızlandırması",Desc: "Kapatma işlemini iyileştirmek için uygulama gecikmelerini azaltın"},
SnippingPrintScreen: {Name: "Ekran Alıntısı PrtSc"},
System: {Name: "Sistem"},
Text_ClearStartMenu_Done: "Başlat Menüsü Temizlendi!",
Text_CommandLine: "Komut satırı",
Text_Delete: "Sil",
Text_DeselectAll: "Seçimi Kaldır",
Text_Disable: "Devre Dışı Bırak",
Text_Disabled: "Devre Dışı",
Text_DisableMSDefender0: "Microsoft Defender'ı etkinleştirmek bilgisayarı yeniden başlatmayı gerektirir.`nBu işlemi gerçekleştirmek istediğinize emin misiniz?",
Text_DisableMSDefender1: "Microsoft Defender'ı devre dışı bırakmak bilgisayarı yeniden başlatmayı gerektirir.`nBu işlemi gerçekleştirmek istediğinize emin misiniz?",
Text_Enable: "Etkinleştir",
Text_Enabled: "Etkin",
Text_FindRegistry: "Kayıt Defterinde Bul",
Text_HR_Optimize: "------- Optimize Et -------",
...
UnpinTaskbar: {Name: "Görev Çubuğunu Kaldır"},
UnpinTaskView: {Name: "Görev Görünümü"},
UnpinWidgets: {Name: "Araçlar"}
},
zh_cn: {
Name: "中文（简体）",
Translator: "Jvcon",
...
HostsEdit_BtnInsertLink: {Desc: "插入链接以导入到主机"},
