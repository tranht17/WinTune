...
BtnSys_LoadOptimizeConfig: {Desc: "最適化構成ファイルの読み込み"},
...
DisableCustomInking: {Name: "カスタム手書き入力を無効にする",Desc: "カスタム手書き入力と入力辞書を無効にすます"},
...
DisableWCE: {Name: "WCE 拡張機能を無効にする",Desc: "Windows カスタマー エクスペリエンス向上を無効にする`n`n- プロキシ: このタスクは、Microsoft カスタマー エクスペリエンス向上プログラムにオプトインしている場合、autochk SQM データを収集してアップロードします。`n- Microsoft Compatibility Appraiser: Microsoft カスタマー エクスペリエンス向上プログラムにオプトインした場合は、プログラム テレメトリ情報を収集します。"},
...
Link_DeselectAll: {Name: "Text_DeselectAll"},
Link_SelectAll: {Name: "Text_SelectAll"},
LinkResolveIgnoreLinkInfo: {Name: "リンク解決時に LinkInfo を無視する",Desc: "ローミング中にシェルのショートカットを追跡しない"},
